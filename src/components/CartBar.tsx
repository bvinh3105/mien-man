...
// ============================================================
// CartBar — icon giỏ hàng trên navbar, mở CartDrawer khi click
// ============================================================
  ...
  return (
    <>
      <button
        ...
        className="relative inline-flex items-center justify-center w-10 h-10 rounded-full hover:bg-sage-50 transition"
      >
